  ...
  class Interface
    ...
    def initialize(type)
      ...
      when :command_line
        ...
        fail InterfaceError, "Attempted to initialize interface with invalid type: #{type}"
      end
    end
    ...
    def game_setup_interaction(player_marks)
      if @interface.respond_to?(:game_setup_interaction)
        ...
        fail InterfaceError, "#{self.class}#game_setup_interaction is not implemented"
      end
    end
    ...
    def show_game_board(board)
      if @interface.respond_to?(:show_game_board)
        ...
        fail InterfaceError, "#{self.class}#show_game_board is not implemented"
      end
    end
    ...
    def solicit_move(player_mark)
      if @interface.respond_to?(:solicit_move)
        ...
        fail InterfaceError, "#{self.class}#solicit_move is not implemented"
      end
    end
    ...
    def report_move(player_mark, move_coordinates)
      if @interface.respond_to?(:report_move)
        ...
        fail InterfaceError, "#{self.class}#report_move is not implemented"
      end
    end
    ...
    def report_game_over(player_mark)
      if @interface.respond_to?(:report_game_over)
        ...
        fail InterfaceError, "#{self.class}#report_game_over is not implemented"
      end
    end
  end
end
